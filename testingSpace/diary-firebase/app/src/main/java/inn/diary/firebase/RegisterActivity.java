...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText mEmailText, mPasswordText, mPasswordcheckText;
    Button mregisterBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailText = findViewById(R.id.edt_reg_email);
        mPasswordText = findViewById(R.id.edt_reg_password);
        mPasswordcheckText = findViewById(R.id.edt_reg_passwordcheck);
        mregisterBtn = findViewById(R.id.btn_reg_sub);
        ...
        mregisterBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(pwd.isEmpty() || email.isEmpty() || pwdcheck.isEmpty()){
